#include "./OPUSim_ControlLawDynamicObstacle/OPUSim_ControlLawDynamicObstacle.h"
...
int main(int argc, char* argv[])
{
	...
	ros::init(argc, argv,std::string("OPUSim_ControlLawDynamicObstacle_"+std::to_string(robot_number)).c_str() );

	OPUSim_ControlLawDynamicObstacle cl(robot_number, emergencyBreak, verbose, gain_, R_, a_, epsilon_, kv_, kw_, Omega_);
